...
const CreateExpertSuccess = (props) => {
  ...
  const handleClick = () => {
    ...
    props.history.push('/profile-expert');
  }
    ...
    >
      <div className="text-center">
        ...
        <p className="an-18 mb20 regular-text">
          Your profile is successfully created. We will review your profile &
...
export default compose(withRouter)(CreateExpertSuccess);
