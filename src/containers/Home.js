        ...
        <div className="container align-center">
          <div className="banner_txt">
            ...
            <p className="an-18 medium-text">
              Join a worldwide community of adventurers. <br></br> Connect and
              learn from experts. Help protect <br></br> the planet.
            </p>
          ...
          <div className="join_sec h_padding" id="join-expeditions">
            ...
            <Row>
              <Col>
                <div className="text-center">
                  <Button
                    className="start_exploring an-20 mt10"
                    onClick={openSignup}
                  >
                    Start exploring
                  </Button>
            ...
            <Row className="flex_sec">
              ...
              <Col span={8}>
                <div className="h_sub_title">
                  ...
                  <span>2</span>
                  <p className="an-16">
                    Both beginners and seasoned explorers can access our pool of
                    learning resources crafted by experts in a variety of
                    different adventure travel fields.
                  </p>
                </div>
              </Col>
            </Row>
              ...
              <Col span={16}>
                <div className="h_sub_title">
                  ...
                  <p className="an-16">
                    ...
                    <br></br>
                    professional who know how to keep you safe. Learn about
                    <br></br>
                    the natural world, leave a positive impact and make memories
                    <br></br>
                    to last a lifetime.
                  </p>
                </div>
                ...
                <OwlCarousel className="owl-theme" {...options} margin={40}>
                  <div className="item">
                    <div className="grid">
                      ...
                      <p className="an-16 medium-text">Climbing and Trekking</p>
                    </div>
                  </div>
                  <div className="item">
                    <div className="grid">
                      ...
                      <p className="an-16 medium-text">Hiking</p>
                    </div>
                  </div>
                  <div className="item">
                    <div className="grid">
                  ...
                  <div className="item">
                    <div className="grid">
                      ...
                      <p className="an-16 medium-text">Birdwatching</p>
                    </div>
                  </div>
                  <div className="item">
                    <div className="grid">
                  ...
                  <div className="item">
                    <div className="grid">
                      ...
                      <p className="an-16 medium-text">Kayaking and Rafting</p>
                    </div>
                  </div>
                </OwlCarousel>
              </Col>
